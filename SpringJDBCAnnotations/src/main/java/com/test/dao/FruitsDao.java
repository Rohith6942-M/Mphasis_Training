...
public class FruitsDao {
	...
	private final String insert_sql = "insert into fruits (id,f_name,f_price,t_quantity) values(?,?,?,?)";
	private final String update_sql = "update fruits set f_name = ?, f_price = ?, t_quantity = ? where id = ?";
